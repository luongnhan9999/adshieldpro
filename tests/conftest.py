...
CONTRACT_SCHEMA = {
    ...
    "methods": {
        ...
        "file_dispute": {"params": ["str", "str"], "kwparams": {}, "ret": "None", "readonly": False},
        "file_dispute_appeal": {"params": ["str"], "kwparams": {}, "ret": "None", "readonly": False},
        "finalize_settlement": {"params": ["str"], "kwparams": {}, "ret": "None", "readonly": False},
        "cancel_campaign": {"params": ["str"], "kwparams": {}, "ret": "None", "readonly": False},
        "get_all_campaigns": {"params": [], "kwparams": {}, "ret": "str", "readonly": True},
